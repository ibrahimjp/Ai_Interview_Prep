...
export default function CustomSignIn() {
  return (
    <div className="min-h-screen flex items-center justify-center  bg-gradient-to-tr from-[#4a3179] via-[#2c0c4f] to-[#4f3d86]">
      <motion.div
      ...
      >
        ...
        <p className="text-center mb-6 text-sm text-gray-300">
          Sign Up to supercharge your prep journey.
        </p>
